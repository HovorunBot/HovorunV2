...
@pytest.mark.asyncio
async def test_cache_message_encryption(mock_cache_service, mock_chat_service, mock_settings):
...
@pytest.mark.asyncio
async def test_get_message_decryption(mock_cache_service, mock_chat_service, mock_settings):
    ...
    fernet = await service._get_fernet_for_chat(chat_id)
...
@pytest.mark.asyncio
async def test_get_message_no_encryption_fails_when_enabled(mock_cache_service, mock_chat_service, mock_settings):
